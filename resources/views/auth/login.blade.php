      ...
      <div class="card">
             <div class="card-content">
                  ...
                  <div class="field">
                       ...
                       <p class="control">
                            <input type="password" name="password" id="email" class="input {{$errors->has('password')?'is-danger':''}}">
                       </p>
           ...
           <h5 class="has-text-centered m-t-20"><a href="{{route('password.request')}}" class="is-muted">Forgot Password</a>
              </div>
</div>
@endsection
